  ...
  return (
    <div className="bg-white min-h-screen pt-44 pb-24">
      <div className="container mx-auto px-4 max-w-5xl">
        <h1 className="text-4xl md:text-5xl font-heading font-bold  text-green-700 mb-4 uppercase">Cookie Policy for appliancemania</h1>
        <p className="text-gray-500 mb-12 italic">Last Updated: February 21, 2026</p>

        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
          <section>
            <p>
              This Cookie Policy explains how appliancemania (“<strong>Company</strong>,” “<strong>we</strong>,” “<strong>us</strong>,” or “<strong>our</strong>”) uses
              cookies and similar tracking technologies when you visit our website
              <a href="https://appliancemania.shop/" className="text-primary hover:text-secondary"> https://appliancemania.shop/</a> (the “<strong>Website</strong>”). This policy should be read together with our
          ...
          <section>
            ...
            <p>appliancemania uses cookies and similar technologies to:</p>
          ...
          <section>
            ...
            <p>
              ...
              industry standard for recognizing DNT signals, and appliancemania does not currently
          ...
          <section>
            ...
            <address className="not-italic bg-gray-50 p-8 rounded-2xl border border-gray-100 mt-4 leading-relaxed font-bold">
              ...
              United States<br />
              Email: <a href="mailto:info@appliancemania.shop" className="text-primary">info@appliancemania.shop</a>
            </address>
          </section>
        </div>
      </div>
