  ...
  <ServiceLayout 
    ...
    extraContent={
      <div className="space-y-16">
        ...
        <section className="bg-gray-950 p-10 md:p-12 rounded-[48px] text-white relative overflow-hidden group shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
            <div className="space-y-6">
              <h4 className="text-emerald-500 font-black uppercase text-[10px] tracking-[0.3em]">Fluid Dynamics</h4>
            ...
            <div className="space-y-6">
              <h4 className="text-amber-500 font-black uppercase text-[10px] tracking-[0.3em]">Thermal & Grind</h4>
              <ul className="space-y-4">
                {[
        ...
        <section>
          <h3 className="text-2xl font-black text-gray-950 mb-6 uppercase tracking-tighter">Clinical Hygiene Protocol</h3>
