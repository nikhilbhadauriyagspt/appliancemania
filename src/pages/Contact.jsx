      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        <div className="mt-32 p-12 lg:p-20 rounded-[64px] bg-gray-950 relative overflow-hidden group">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[9px] font-black tracking-[0.3em] text-emerald-400 uppercase mb-8">
                <Shield size={12} /> The APPLIANCEMANIA Guarantee
              </div>
