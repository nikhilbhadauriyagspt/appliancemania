    ...
    <div className="pt-24 pb-0 bg-white min-h-screen">
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-blue-600 font-bold text-xs uppercase tracking-widest mb-4 block">About FixMyGear</span>
              ...
              <p className="text-gray-500 text-lg leading-relaxed mb-8 max-w-xl">
                Founded in 2015, we have been dedicated to providing top-tier appliance repair services. We believe in quality, transparency, and the long-term reliability of your home equipment.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1">
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-3xl overflow-hidden shadow-lg h-64 border-4 border-gray-50">
                  <img src="https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?q=80&w=1000&auto=format&fit=crop" className="w-full h-full object-cover" alt="Detail" />
                </div>
                <div className="rounded-3xl overflow-hidden shadow-lg h-64 mt-8 border-4 border-gray-50">
                  <img src="https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=1000&auto=format&fit=crop" className="w-full h-full object-cover" alt="Detail" />
                </div>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              ...
              <p className="text-gray-500 mb-8 leading-relaxed">
                At FixMyGear, we understand that a broken appliance is more than just a minor inconvenience. It's a disruption to your daily routine. That's why our process is designed to be as seamless and efficient as possible.
              </p>
      ...
      <section className="py-24 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 max-w-xl mx-auto mb-12 font-medium">Join thousands of happy customers who trust FixMyGear for their home appliance maintenance and repairs.</p>
